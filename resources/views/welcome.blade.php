...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>UPT PUPR PASIRWANGI</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="/"><img src="https://www.garutkab.go.id/assets/img/logo-kabupaten-garut.png" height="31" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="/home">LOGIN</a></div>
          </div>
        </div>
      </nav>
      <section class="pt-7">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
              <h1 class="mb-4 fs-9 fw-bold">UPT PUPR PASIRWANGI</h1>
              <p class="mb-6 lead text-secondary">UNIT PELAYANAN TERPADU DINAS PUPR KABUPATEN GARUT</p>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="container">
          <h1 class="fs-9 fw-bold mb-4 text-center"> TUGAS POKOK<br class="d-none d-xl-block" />DAN FUNGSI</h1>
          <div class="row">
      ...
      <section class="pt-5" id="validation">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <h5 class="text-secondary">PENGAWASAN</h5>
              <h2 class="mb-2 fs-7 fw-bold"></h2>
              <p class="mb-4 fw-medium text-secondary">
                PENGAWASAN KEGIATAN KHUSUS DI KECAMATAN PASIRWANGI
              </p>
      ...
      <section class="pt-5" id="manager">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <h5 class="text-secondary">PEMBINAAN</h5>
            
              <p class="mb-4 fw-medium text-secondary">
                PEMBINAAN DILAPANGAN TERKAIT PELAKSANAAN KEGIATAN
              </p>
      ...
      <section class="pt-5" id="marketer">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <h5 class="text-secondary">KONSULTASI</h5>
             
              <p class="mb-4 fw-medium text-secondary">KONSULTASI KEGIATAN.</p>
      ...
      <section class="pt-5" id="marketing">
        ...
        <div class="container">
          <h1 class="fw-bold fs-6 mb-3">Link Terkait</h1>
          <p class="mb-6 text-secondary"></p>
          <div class="row">
